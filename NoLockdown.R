...
scenario_0 = vector('list',nsim)      # Define Scenario_0: No lockdown. India does nothing and let the disease run its course. Schools close on 1 April 2020 and reopen on 1 June 2020 as part of Summer Holidays.
...
for(sim in 1:nsim)
{
  scenario_0[[sim]] = simulateOutbreakSEIcIscR(R0t = R0est[sim],
                                               dateStart = as.Date("2020-03-02"),
                                               dateStartIntenseIntervention = as.Date('2020-03-02'), 
                                               dateEndIntenseIntervention = as.Date('2020-03-02'),
                                               pWorkOpen = c(1, 1, 1, 1),
                                               numWeekStagger = c(3, 6, 9),
                                               pInfected = initialI,
                                               durInf = durInfSim,

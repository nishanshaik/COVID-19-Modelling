...
scenario_2 = vector('list',nsim)      # Define Scenario_2:The extended lockdown of 42 days, with 50% lockdown efficiency. Exit strategy of 3-weekly staggers of 65%, 85% and 100%. 
...
for(sim in 1:nsim)
{
  scenario_2[[sim]] = simulateOutbreakSEIcIscR(R0t = R0est[sim],

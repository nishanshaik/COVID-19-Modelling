...
scenario_5 = vector('list',nsim)      # Define Scenario_0: Current lockdown with only 50% lockdown efficiency to include the migrations that have happened and the lockdown violations rampant in the country. Exit strategy of 3-weekly staggers of 65%, 85% and 100%. 
...
for(sim in 1:nsim)
{
  scenario_5[[sim]] = simulateOutbreakSEIcIscR(R0t = R0est[sim],
